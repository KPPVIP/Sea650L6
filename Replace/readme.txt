Sea ray 650fly by RsMods


X:\programmes\rockstar games\mods\update\x64\dlcpacks\mpapartment\dlc.rpf\x64\levels\gta5\vehicles\apartmentvehicles.rpf

 Replace files tropic2.ytd, tropic_hi.yft and tropic2.yft



 Vehicles.meta

X:\programmes\rockstar games\mods\update\update.rpf\dlc_patch\mpapartment\common\data\levels\gta5



 <Item>
      <modelName>tropic2</modelName>
      <txdName>tropic2</txdName>
      <handlingId>TROPIC</handlingId>
      <gameName>TROPIC</gameName>
      ...
      <maxNum value="999" />
      <flags>FLAG_NO_BOOT FLAG_SPAWN_BOAT_ON_TRAILER FLAG_EXTRAS_REQUIRE FLAG_EXTRAS_STRONG FLAG_PEDS_CAN_STAND_ON_TOP FLAG_GEN_NAVMESH FLAG_HEADLIGHTS_USE_ACTUAL_BONE_POS FLAG_DONT_SPAWN_AS_AMBIENT</flags>
